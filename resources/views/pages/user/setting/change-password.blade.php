    ...
    <main>
        ...
        <div class="container-xl px-4 mt-4">
            ...
            <nav class="nav nav-borders">
                <a class="nav-link {{ (request()->is('user/setting-user')) ? 'active ms-0' : '' }}" href="{{ route('setting-user.index') }}">Profil</a>
                <a class="nav-link {{ (request()->is('user/setting-user/password')) ? 'active ms-0' : '' }}" href="{{ route('change-password-user') }}">Ubah Password</a>
            </nav>
            <hr class="mt-0 mb-4" />
            <div class="row">
                <div class="col-lg-8">
